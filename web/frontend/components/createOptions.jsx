  ...
  fetchDataFromGetApi = async () => {
    ...
    if (option_set_data.data.status) {
      ...
      if (option_set_data.data.response.length > 0) {
        ...
        // console.log('log the api name',all_names);
        let allch = [];
        option_set_data.data.response.map((element) => {
          ...
          // console.log('push in the data******',all_names);
        });
      ...
      if (this.state.editId != "create-new") {
        ...
        editcreateoptionsdata.map((element)=>{
          obj.all_names.push({ name: element.name, id: element._id });
          // console.log('else map',obj.all_names);
        })
        // console.log('after map result',obj.all_names);
        
        // console.log('name from edit data....',this.state.allNames);
        this.setState({
